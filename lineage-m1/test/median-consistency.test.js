...
test("the generated limitation table agrees with the guardrail medians", () => {
  ...
  const seeds = zoneLoads.map((load, i) => ({
    ...
    firstAdditionalMixedWorldCanopyAncestryReachesShoreline: 3,
    firstAdditionalMixedWorldShorelineAncestryReachesCanopy: 3,
  ...
  const results = {
    ...
    lifecycle: {
      ...
      additionalMixedWorldCanopyAncestryReachesShoreline: { seedsReaching: 4, ofSeeds: 4, medianFirstGeneration: 3, earliestGeneration: 3 },
      additionalMixedWorldShorelineAncestryReachesCanopy: { seedsReaching: 4, ofSeeds: 4, medianFirstGeneration: 3, earliestGeneration: 3 },
