...
|---|---|---|---|---|
| 1 | Full test suite | §20 | `audit/test-results.txt` (TAP summary) | **PASS** — 399/399, 0 failing |
...
| full test suite from clean | 399/399, 0 failures |
...
| every automated result reproducible from a clean run | met — 399/399 from clean, 0 gate(s) FAIL, 0 UNVERIFIED |
