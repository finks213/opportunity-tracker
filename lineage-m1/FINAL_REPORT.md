...
- 2 failing test(s) map to no declared gate
...
|---|---|---|---|---|
| 1 | Full test suite | §20 | `audit/test-results.txt` (TAP summary) | **FAIL** — 410/412, 2 failing |
...
| full test suite from clean | 410/412, 2 failures |
...
| every automated result reproducible from a clean run | NOT met — 410/412 from clean, 1 gate(s) FAIL, 34 UNVERIFIED |
